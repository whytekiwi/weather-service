...
// In production, these wouldn't be validated in application code, but rather in APIM or similar
...
builder.Services.AddSingleton(sp => new ApiKeyValidationService(validApiKeys));
